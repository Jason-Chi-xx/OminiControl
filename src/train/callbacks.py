...
class TrainingCallback(L.Callback):
    ...
    def generate_a_sample(
        ...
        if condition_type == "subject":
            ...
            image_pils = [Image.open("assets/1.png").convert("RGB")]
            test_list.append(
                (   
                    image_pils,
                    image_base64,
        ...
        for i, (image_pils, image_base64, position_delta, prompt, *others) in enumerate(test_list):
            if not condition_type == "metaquery":
                condition = Condition(
